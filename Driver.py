...
def main():
    ...
    # IMPORT DATA SETS, GENERATE CLASSIFICATION + ACCURACY STATS
    print("BREAST CANCER")
    ...
    datasetClassificationInfo = [breastCancerLayerFoldClassifications, glassLayerFoldClassifications, soybeanLayerFoldClassifications, abaloneLayerFoldClassifications, computerLayerFoldClassifications, forestLayerFoldClassifications]
    ...
    datasetAccuracies = [breastCancerTotalAccuracyStats, glassTotalAccuracyStats, soybeanTotalAccuracyStats, abaloneTotalAccuracyStats, computerTotalAccuracyStats, forestTotalAccuracyStats]
